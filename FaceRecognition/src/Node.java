...
/**
 * Node: This class is used by the neural network and represents a position in the image.
 * For the perceptron to be able to learn, each Node contains 4 weights, one weight for
 * each facial expression. When the network is learning it adjusts the node weights 
 * depending on the result it gets when checking against each expression.
 */
public class Node {
